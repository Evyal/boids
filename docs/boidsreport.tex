...
\definecolor{github-bg}{HTML}{F6F8FA}      % Light gray background
\definecolor{github-border}{HTML}{E1E4E8}  % Subtle border color

% --- GitHub-Like Style for Bash Without Colors ---
\lstdefinestyle{github-bash}{
  backgroundcolor=\color{github-bg},
  rulecolor=\color{github-border},
  frame=single,
  % 'keywordstyle' is for normal C++ keywords (if, for, while, int, etc.)
